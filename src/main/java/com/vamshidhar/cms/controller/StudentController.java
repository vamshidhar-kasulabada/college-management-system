...
public class StudentController {
    ...
    @PostMapping
    public ResponseEntity<StudentProjection> createStudent(@RequestBody @Valid StudentDTO student) {
        return new ResponseEntity<>(studentService.createStudent(student), HttpStatus.CREATED);
    }

    @PostMapping("/addAll")
    public Set<StudentProjection> createStudents(@RequestBody @Valid Set<StudentDTO> students) {
    ...
    @PutMapping("/{id}")
    public StudentProjection updateStudent(@PathVariable Long id, @RequestBody @Valid StudentDTO student){
